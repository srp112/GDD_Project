...
STATISTICS = ['Min_5_95', 'Max_5_95', 'average', 'Min_25_75', 'Max_25_75']
...
def make_plot(source, title):
    ...
    plot.quad(top='Max_5_95', bottom='Min_5_95p', left='left', right='right', color=colors[2], source=source, legend="Record")
    plot.quad(top='average', left='left', right='right', color=colors[1], source=source, legend="Average")
    plot.quad(top='Max_25_75', bottom='Min_25_75', left='left', right='right', color=colors[0], alpha=0.5, line_color="black", source=source, legend="Actual")
...
df = pd.read_csv(join(dirname('2015_weather.csv'), '2015_weather.csv'))
