        ...
        with open('data/'+file_name, "r") as files:
          ...
          if user_input in check_year_in_file:
           with open('data/'+file_name, "rU") as files: 
            ...
            plt.plot(GDD_1, 'red', label = "GDD=10")
            plt.plot(GDD_2, 'green', label = "GDD=11")
            plt.plot(GDD_3, 'blue', label = "GDD=12")
            plt.plot(GDD_4, 'black', label="GDD=13")
            plt.plot(GDD_5,'yellow', label="GDD=14")
            plt.plot(GDD_6, 'grey', label="GDD=15")
            plt.xlim(0, 400)
            plt.xlabel("Days")
            plt.ylabel("GDD")
